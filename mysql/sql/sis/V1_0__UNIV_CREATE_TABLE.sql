...
ALTER TABLE UNIV_LESSON_TIME_PERCENT
    ADD CONSTRAINT UNIV_LESSON_TIME_PERCENT_LESSON_ID FOREIGN KEY (LESSON_ID) REFERENCES UNIV_LESSON (LESSON_ID);

ALTER TABLE UNIV_LESSON_EXAM_PERCENT
    ADD CONSTRAINT UNIV_LESSON_EXAM_PERCENT_LESSON_ID FOREIGN KEY (LESSON_ID) REFERENCES UNIV_LESSON (LESSON_ID);

ALTER TABLE UNIV_LESSON_SCHEDULE
    ADD CONSTRAINT UNIV_LESSON_SCHEDULE_DEPARTMENT_ID FOREIGN KEY (DEPARTMENT_ID) REFERENCES UNIV_DEPARTMENT (DEPARTMENT_ID);

ALTER TABLE UNIV_EXAM_SCHEDULE
    ADD CONSTRAINT UNIV_EXAM_SCHEDULE_DEPARTMENT_ID FOREIGN KEY (DEPARTMENT_ID) REFERENCES UNIV_DEPARTMENT (DEPARTMENT_ID);
