...
(
    ...
    MEAN_OF_NOTE       DOUBLE,
    STATUS             ENUM ('UNFINALISED', 'PASSED', 'FAILED', 'FAILED_FROM_ABSENTEEISM') NOT NULL,
    CREATED_DATE       TIMESTAMP,
    CREATED_USER_ID    NUMERIC(12),
    MODIFIED_DATE      TIMESTAMP,
    MODIFIED_USER_ID   NUMERIC(12)
...
(
    ...
    LESSON_ID               NUMERIC(8),
    WEEK                    NUMERIC(2),
    THEORETICAL_HOURS_STATE ENUM ('NOT_EXIST', 'NOT_ENTERED', 'ENTERED') NOT NULL,
    THEORETICAL_HOURS       NUMERIC(2),
    MAX_THEORETICAL_HOURS   NUMERIC(3),
    PRACTICE_HOURS_STATE    ENUM ('NOT_EXIST', 'NOT_ENTERED', 'ENTERED') NOT NULL,
    PRACTICE_HOURS          NUMERIC(2),
    MAX_PRACTICE_HOURS      NUMERIC(3),
    STATUS                  ENUM ('NOT_ENTERED', 'ENTERED', 'FAILED')    NOT NULL,
    CREATED_DATE            TIMESTAMP,
    CREATED_USER_ID         NUMERIC(12),
    MODIFIED_DATE           TIMESTAMP,
    MODIFIED_USER_ID        NUMERIC(12)
...
ALTER TABLE STUDENT_LESSON_ABSENTEEISM
    ADD CONSTRAINT STUDENT_LESSON_ABSENTEEISM_TEACHER_ID FOREIGN KEY (TEACHER_ID) REFERENCES TEACHER_ACADEMIC_INFO (TEACHER_ID);
ALTER TABLE STUDENT_LESSON_ABSENTEEISM
